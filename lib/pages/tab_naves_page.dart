...
class TabNavesPage extends StatefulWidget {
  TabNavesPage({Key? key}) : super(key: key);

  @override
  _TabNavesPageState createState() => _TabNavesPageState();
}

class _TabNavesPageState extends State<TabNavesPage> {
  ...
  Future<List<dynamic>> cargarDatos(int numPagina) async {
    var data = await provider.getData(tipo: 'starships', pagina: numPagina);
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(listaDatos[index]['model']),
                      );
                    },
                  );
                }
